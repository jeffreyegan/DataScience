...
Throughout the rest of this lesson, you'll learn about the different syntax of regular expressions and how you can use them in your own projects (and become a regex superhero)!
...
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/on'
...
key = 'cat|dog'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyour'
...
'''
key = '[chr]at'  # matches cat, hat, rat but not eat, mat, sat
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexciting'
...
key = '....\.'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexcitingjourney'
...
key = '[c-e][uol][bgk]'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexcitingjourneylearning'
...
key = '\d\s\w\w\w\w\w[s]'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexcitingjourneylearningto'
...
'''
key = '(puppies|kitty cats) are my favorite!'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexcitingjourneylearningtocode'
...
key = 'sque\w{3,5}k'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexcitingjourneylearningtocodeyou'
...
'''
key = '(\d) duck(s)? for adoption\?'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexcitingjourneylearningtocodeyouwill'
...
key = 'hooo*t'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexcitingjourneylearningtocodeyouwillfind'

'''
Anchors

When writing regular expressions, it's useful to make the expression as specific as possible in order to ensure that we do not match unintended text. To aid in this mission of specificity, we can use the anchor metacharacters. The anchors hat ^ and dollar sign $ are used to match text at the start and end of a string, respectively.
...
'''
key = '^penguins are cooler than regular expressions$'
# Add the hidden key from the browser to the end of the URL given below
url = 'https://s3.amazonaws.com/codecademy-content/courses/regex/onyourexcitingjourneylearningtocodeyouwillfindthis.gif'
...
Do you feel those regular expression superpowers coursing through your body? Do you just want to scream ah+ really loud? Awesome! You are now ready to take these skills and use them out in the wild. Before beginning your adventures, let's review what we've learned.
    ...
    Alternation, using the pipe symbol |, allows us to match the text preceding and following the |
