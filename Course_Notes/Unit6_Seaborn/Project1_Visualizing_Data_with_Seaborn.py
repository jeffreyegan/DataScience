...
ax = sns.barplot(data=df, y="Total Goals", x="Year")
ax.set_title("Average Number of Goals Scored at Each World Cup")
plt.show()
...
ax.set_title("Box Plot of Goals Scored at Each World Cup")
plt.show()
